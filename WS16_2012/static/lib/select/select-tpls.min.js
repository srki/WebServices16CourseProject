angular.module("oi.select", []), angular.module("oi.select").provider("oiSelect", function () {
    ...
    function s(e) {
        ...
        if (r)return t = r.documentElement, n = l(r), {
    ...
    return {contains: n, bindFocusBlur: o, scrollActiveOption: r, groupsIsEmpty: a, objToArr: c, getValue: p, intersection: d}
    ...
    return {
        restrict: "AE", templateUrl: "src/template.html", require: "ngModel", scope: {}, compile: function (e, p) {
            ...
            return function (e, r, c, d) {
                function p() {
                    at && r.removeClass("cleanMode"), at = !1
                }
                ...
                function L(t) {
                    u.contains(r[0], t.target, "disabled") || e.output.length >= y && u.contains(r[0], t.target, "select-dropdown") || (e.inputHide && e.removeItem(0), !e.isOpen || !lt.closeList || "INPUT" === t.target.nodeName && e.query.length ? J(e.query) : (Z({query: lt.editItem && !at}), e.$evalAsync()))
                }
                ...
                function E(o, r) {
                    r || (r = o, o = e.query);
                    var i, s = lt.saveTrigger.split(" ").indexOf(r) + 1, l = lt.newItem && o, u = "blur" !== r ? e.order[e.selectorPosition] : null;
                    return s && (l || u) ? (e.showLoader = !0, i = t.when(u || S(e.$parent, {$query: o})), i.then(function (o) {
                        ...
                        e.selectorPosition === r && et(ot, 0), lt.newItemFn && !u || n(angular.noop), Z()
                    }).catch(function () {
                ...
                function x() {
                    var e = w && Y(d.$modelValue) ? it : rt;
                    nt.attr("placeholder", e)
                }
                ...
                function J(o, i) {
                    return v && ct && n.cancel(v), v = n(function () {
                        var s = _(e.$parent, {$query: o, $selectedAs: i}) || "";
                        return e.selectorPosition = "prompt" === lt.newItem ? !1 : 0, o || i || (e.oldQuery = null), (s.$promise && !s.$resolved || angular.isFunction(s.then)) && (ct = lt.debounce), e.showLoader = !0, t.when(s.$promise || s).then(function (t) {
                            if (e.groups = {}, t && !i) {
                                var n = w ? e.output : [], s = vt(u.objToArr(t), o, W, $t(e.$parent), r), l = u.intersection(s, n, C, C, !0), a = z(l);
                                e.groups = tt(a)
                            }
                            return K(), t
                        }).finally(function () {
                            e.showLoader = !1, lt.closeList && !lt.cleanModel && n(function () {
                                et(ot, 0)
                            })
                        })
                    }, ct)
                ...
                function Z(t) {
                    t = t || {}, e.oldQuery = null, e.backspaceFocus = !1, e.groups = {}, e.order = [], e.showLoader = !1, e.isOpen = !1, ct = 0, t.query || (e.query = ""), v && n.cancel(v)
                }
                ...
                var nt = r.find("input"), ot = angular.element(r[0].querySelector(".select-dropdown")), rt = Q(e), it = M(e), st = U(e.$parent) || {}, lt = angular.extend({cleanModel: "prompt" === st.newItem}, a.options, st), ut = lt.editItem, at = "correct" === ut, ct = 0;
                (ut === !0 || "correct" === ut) && (ut = "oiSelectEditItem");
                var dt = ut ? i.get(ut) : angular.noop, pt = o(lt.removeItemFn);
                g = lt.searchFilter.split(":");
                var ft = s(g[0]), gt = o(g[1]);
                g = lt.dropdownFilter.split(":");
                var mt = s(g[0]), ht = o(g[1]);
                g = lt.listFilter.split(":");
                var vt = s(g[0]), $t = o(g[1]);
                g = lt.groupFilter.split(":");
                var bt = s(g[0]), wt = o(g[1]);
                S = lt.newItemFn ? o(lt.newItemFn) : function (e, t) {
                    return (U(t) || {}).newItemModel || t.$query
                }, !lt.cleanModel || ut && !at || r.addClass("cleanMode");
                var yt = u.bindFocusBlur(r, nt);
                angular.isDefined(c.autofocus) && n(function () {
                    nt[0].focus()
                }), angular.isDefined(c.readonly) && nt.attr("readonly", !0), angular.isDefined(c.tabindex) && (nt.attr("tabindex", c.tabindex), r[0].removeAttribute("tabindex")), lt.maxlength && nt.attr("maxlength", lt.maxlength), c.$observe("disabled", function (t) {
                    nt.prop("disabled", t), w && d.$modelValue && d.$modelValue.length && (e.inputHide = t)
                }), e.$on("$destroy", yt), e.$parent.$watch(c.multipleLimit, function (e) {
                    y = Number(e) || 1 / 0
                    ...
                    E(t.slice(0, -1), t.slice(-1)) || (t === n || e.oldQuery && !t || h || (ot[0].scrollTop = 0, t ? (J(t), e.oldQuery = null) : w && (Z(), h = !0)), h = !1)
                    ...
                    if ($ = e.query, !w || !u.intersection(e.output, [t], C, C).length) {
                        ...
                        n.splice(n.indexOf(t), 1), w ? d.$setViewValue(angular.isArray(d.$modelValue) ? d.$modelValue.concat(o) : [o]) : (d.$setViewValue(o), I()), u.groupsIsEmpty(e.groups) && (e.groups = {}), w || lt.closeList || Z({query: !0}), p(), e.oldQuery = e.oldQuery || e.query, e.query = "", e.backspaceFocus = !1
                    }
                }, e.removeItem = function (n) {
                    c.disabled || w && 0 > n || (b = w ? d.$modelValue[n] : d.$modelValue, t.when(pt(e.$parent, {$item: b})).then(function () {
                        (w || e.inputHide) && (w ? (d.$modelValue.splice(n, 1), d.$setViewValue([].concat(d.$modelValue))) : (k(), lt.cleanModel && d.$setViewValue(void 0)), (w || !e.backspaceFocus) && (e.query = dt(b, $, W, at, r) || ""), w && lt.closeList && Z({query: !0}))
                    }))
                }, e.setSelection = function (t) {
                    m || e.selectorPosition === t ? m = !1 : et(ot, t)
                }, e.keyUp = function (t) {
                    switch (t.keyCode) {
                        case 8:
                    ...
                    switch (t.keyCode) {
                        case 38:
                            e.selectorPosition = angular.isNumber(e.selectorPosition) ? e.selectorPosition : n, et(ot, e.selectorPosition === n ? o : e.selectorPosition - 1), m = !0;
                            break;
                        case 40:
                            e.selectorPosition = angular.isNumber(e.selectorPosition) ? e.selectorPosition : n - 1, et(ot, e.selectorPosition === o ? n : e.selectorPosition + 1), m = !0, e.query.length || e.isOpen || J(), e.inputHide && k();
                            break;
                        case 37:
                        case 39:
                            break;
                        ...
                        case 32:
                            ...
                            break;
                        case 27:
                            w || (I(), lt.cleanModel && d.$setViewValue(b)), Z();
                            break;
                        case 8:
                            if (!e.query.length) {
                                if ((!w || ut) && (e.backspaceFocus = !0), e.backspaceFocus && e.output && (!w || e.output.length)) {
                                    e.removeItem(e.output.length - 1), ut && t.preventDefault();
                                    break
                                }
                    ...
                    var n = W(t);
                    return ft(n, e.oldQuery || e.query, t, gt(e.$parent), r)
                }, e.getDropdownLabel = function (t) {
                    var n = W(t);
                    return mt(n, e.oldQuery || e.query, t, ht(e.$parent), r)
                }, e.getGroupLabel = function (t, n) {
                    return bt(t, e.oldQuery || e.query, n, wt(e.$parent), r)
